...
import shippingcard from "../../images/shippingcard.png";
...
import productitem3 from "../../images/product-item2.jpg"
import productitem4 from "../../images/product-item2.jpg"
import productitem5 from "../../images/product-item2.jpg"
import productitem6 from "../../images/product-item2.jpg"
import productitem7 from "../../images/product-item2.jpg"
import productitem8 from "../../images/product-item2.jpg"
import productitem9 from "../../images/product-item2.jpg"
import productitem10 from "../../images/product-item2.jpg"
import postitem1 from "../../images/post-item1.jpg"
import postitem2 from "../../images/post-item1.jpg"
import postitem3 from "../../images/post-item1.jpg"
import instaitem1 from "../../images/insta-item1.jpg"
import instaitem2 from "../../images/insta-item2.jpg"
import instaitem3 from "../../images/insta-item3.jpg"
import instaitem4 from "../../images/insta-item4.jpg"
import instaitem5 from "../../images/insta-item5.jpg"
const Home = () => {
  return (
    <>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem1} alt="product-item" class="img-fluid"></img>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem2} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem3} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem4} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem5} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
          ...
          <div class="swiper product-watch-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem6} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem7} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem8} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem9} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src={productitem10} alt="product-item" class="img-fluid"></img>
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlinkHref="#cart-outline"></use></svg></a>
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src={postitem1} alt="" class="img-fluid"></img>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src={postitem2} alt="" class="img-fluid"></img>
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src={postitem3} alt="" class="img-fluid"></img>
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-md-5 col-sm-12">
              <form class="subscription-form validate">
                <div class="input-group flex-wrap">
                  <input class="form-control btn-rounded-none" type="email" name="EMAIL" placeholder="Your email address here" required=""></input>
          ...
          <div class="d-flex flex-wrap">
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src={instaitem1} alt="instagram" class="insta-image"></img>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src={instaitem2} alt="instagram" class="insta-image"></img>
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlinkHref="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src={instaitem3} alt="instagram" class="insta-image"></img>
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlinkHref="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src={instaitem4} alt="instagram" class="insta-image"></img>
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlinkHref="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src={instaitem5} alt="instagram" class="insta-image"></img>
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlinkHref="#instagram"></use>
                  </svg>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="Shipping d-flex">
              ...
              <div class="card-wrap ps-2">
                <img src={dhl} alt="visa"></img>
                <img src={shippingcard} alt="mastercard"></img>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
